    ...
    <div style={{ fontFamily: "system-ui, sans-serif", lineHeight: "1.4" }}>
      ...
      <div className="w-screen h-screen">
        ...
        <div className="mt-[100px] w-4/5 mx-auto">
          <div className="text-7xl font-semibold w-[500px] h-[300px] rounded-lg transform origin-x-center origin-y-center -rotate-3 phone:w-full phone:h-[300px]"
            style={{ background: "linear-gradient(113.09deg, #C699FF 4.87%, #7045CA 100%)" }}></div>

          <Link to="/posts/yida">
            <div className="p-5 text-white relative right-[30px] bottom-[280px] w-[500px] h-[320px] phone:w-full phone:h-[300px] rounded-lg transform origin-x-center origin-y-center -rotate-3"
              ...
              <div
                ...
                <div className="w-full phone:hidden">
              ...
              <div className="w-full flex justify-end">
                <div
                  className="w-2/3 p-2 mt-1 bg-white rounded-lg leading-6 tracking-wide font-medium text-black transform origin-x-center origin-y-center -rotate-1 phone:line-clamp-4">
                  面试官想了解你是否熟悉最新的 React 开发技巧和最佳实践。他想问的重点是你对 Hooks API 和 className component 两种组件写法的区别和适用场景的理解
                </div>
              </div>
              <div className="mt-7 ml-[160px] phone:hidden">
